...
export const metadata: Metadata = {
  ...
  title: 'Cicerone — il viaggio, in conversazione',
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: '/og.png', width: 1200, height: 630, alt: 'Cicerone — Il viaggio, in conversazione.' }],
  },
  twitter: {
  ...
  return (
    <html lang="it">
      ...
      >
        ...
        <div id="app-splash" aria-live="polite" aria-busy="true" aria-label="Cicerone si sta caricando">
          <style>{`
